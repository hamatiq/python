...
for row in gradebook:
    studentAverage.append(sum(row)/len(row))

Assmatrix = list(zip(*gradebook))
assignmentAverage = []
for row in Assmatrix:
    assignmentAverage.append(sum(row)/len(row))


print("Assignment Averages:")
for x in range(len(assignmentAverage)):
    print("Assignment "+str(x)+": "+str(round(assignmentAverage[x],2)))

print("Student Averages:")
for x in range(len(studentAverage)):
    print("Student "+str(x)+": "+str(round(studentAverage[x],2)))